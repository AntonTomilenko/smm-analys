...
def start(message):
    text = '''Привет. Я бот, который считает ER, учитывая важность разных типов взаимодействий: \
лайков, комментариев, репостов.

Новый показатель мой создатель (@tomilenkoman) назвал \
индексом эффективного вовлечения или Effective Engagement Index (EEI). \
Знать его полезно, чтобы понимать, насколько качественно вовлечена аудиториия во взаимодействие \
с контентом.

<b>Напишите «Поехали» и я начну работать.</b>'''
